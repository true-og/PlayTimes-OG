...
public class DatabaseManager {
    ...
    public void updatePlaytime(UUID uuid, Long playtime, Long afktime) {
        ...
        userPlaytimes.computeIfAbsent(uuid, k -> new HashMap<>()).computeIfAbsent(serverId, k -> new HashMap<>())
    ...
    public void purgeOldPlaytimeData() {
        ...
        Bukkit.getLogger()
                .info(String.format(
                        "[PlayTimes] Purging playtime data for server ID '%s' that is older than %d months.", serverId,
                        months));
