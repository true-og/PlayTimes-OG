...
public class CustomConfig {
    ...
    private void checkAndAddDefaults() {
        ...
        requiredKeys.put("afk-settings.on-enter-afk-message", "&eYou are now marked as AFK.");
        requiredKeys.put("afk-settings.on-exit-afk-message", "&eYou are no longer AFK.");
        ...
        requiredKeys.put("top-playtime.footer", "&b****************************************");
