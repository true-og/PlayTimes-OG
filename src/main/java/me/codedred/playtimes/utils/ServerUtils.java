...
public class ServerUtils {
    ...
    public static boolean isRisenVersion() {
        ...
        if (mcVersion == null) {
            ...
            Bukkit.getLogger().warning("PlayTimes failed to extract Minecraft version: " + version);
            return false;
        ...
        try {
            ...
            int minorVersion = versionParts.length >= 2 ? Integer.parseInt(versionParts[1]) : 0;

            return minorVersion >= 17;

        } catch (NumberFormatException e) {

            Bukkit.getLogger().warning("PlayTimes failed to parse Minecraft version: " + mcVersion);
            return false;
