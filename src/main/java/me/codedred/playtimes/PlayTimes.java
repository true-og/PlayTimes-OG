...
public class PlayTimes extends JavaPlugin {
    ...
    private void registerEvents() {
        ...
        if (data.hasAfkEnabled()) {
            ...
            boolean cancelAfkOnMove = config.getBoolean("afk-settings.cancel-afk.on-player-move");
            boolean cancelAfkOnChat = config.getBoolean("afk-settings.cancel-afk.on-player-chat");
            boolean cancelAfkOnInteract = config.getBoolean("afk-settings.cancel-afk.on-player-interact");
    ...
    private void registerCommands() {
        ...
        Objects.requireNonNull(getCommand("topplaytime")).setExecutor(new TopTime());
    ...
    public void loadDatabase() {
        ...
        if (DataManager.getInstance().getDBConfig().getBoolean("database-settings.enabled")) {
            ...
            try {
                ...
                if (databaseManager.getDataSource().getConnection() != null) {
                    ...
                    if (DataManager.getInstance().getDBConfig().getBoolean("purge-database.enabled"))
